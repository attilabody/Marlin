...
#define CUSTOM_MACHINE_NAME "Frankencube"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like http://www.uuidgenerator.net/version4
#define MACHINE_UUID "d78094fe-3cee-4a68-b5ee-0fcbf86c5947"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST { 24.64, 24.64 }
    #define DEFAULT_Ki_LIST {  1.86,  1.86 }
    #define DEFAULT_Kd_LIST { 81.74, 81.74 }
  #else
  	// BMO hotend
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 1600, 690 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 9, 120 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 4000, 4000, 40, 800 }
...
#define DEFAULT_KEEPALIVE_INTERVAL 60 // Number of seconds between "busy" messages. Set with M113.
