...
#define CUSTOM_MACHINE_NAME "Anycubic Linear Plus"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // from pid autotune. "M303 E-1 C8 S60" to run autotune on the bed at 60 degreesC for 8 cycles
    ...
    #define DEFAULT_bedKp 349.5
    #define DEFAULT_bedKi 67.73
    #define DEFAULT_bedKd 450.98
  #endif
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_DIAGONAL_ROD 280        // (mm) QQ rods
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 552 }  // default steps per unit for Kossel (GT2, 20 tooth)
...
#define HOMING_FEEDRATE_MM_M { (90*60), (90*60), (90*60) }
