...
#define CUSTOM_MACHINE_NAME "FLSUN SR"
...
#define DELTA
  ...
  #define DELTA_MAX_RADIUS 145            // (mm)

  // Center-to-center distance of the holes in the diagonal push rods.
  #define DELTA_DIAGONAL_ROD 315.0        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 335.04             // (mm) Get this value from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 420 }
